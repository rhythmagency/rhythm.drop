...
public sealed record DropSubcomponentTagHelperRendererContext(ISubcomponent? Subcomponent, int Level, string Theme, int Index, int Total, IReadOnlyHtmlAttributeCollection Attributes, ViewContext ViewContext, string? Section)
{
}
