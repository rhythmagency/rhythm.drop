...
public sealed record SubcomponentMetaDataFactoryInput(ISubcomponent Subcomponent, int Index, int Total, string Theme, IReadOnlyHtmlAttributeCollection Attributes, string? Section)
{
}