...
/// </summary>
public static class RhythmBuilderExtensions
{
    /// <summary>
    ...
    /// <remarks>For a more controlled installation use <see cref="ServiceCollectionExtensions.AddRhythmDrop(IServiceCollection, Action{IRhythmDropBuilder})"/></remarks>
